...
public class MqttManager : MonoBehaviour
{
    ...
    {     
        ...
        client.Publish(publishTopic, Encoding.UTF8.GetBytes($"mt1|{motor1Angle}"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
    }

    public void MoveRoboArmServo2(float motor2Angle)
    {     
        client.Publish(publishTopic, Encoding.UTF8.GetBytes("ld|VirtualRoboArm"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
        client.Publish(publishTopic, Encoding.UTF8.GetBytes($"mt2|{motor2Angle}"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
    }

    public void MoveRoboArmServo3(float motor3Angle)
    {     
        client.Publish(publishTopic, Encoding.UTF8.GetBytes("ld|VirtualRoboArm"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
        client.Publish(publishTopic, Encoding.UTF8.GetBytes($"mt3|{motor3Angle}"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
    }

    public void MoveRoboArmServo4(float motor4Angle)
    {     
        client.Publish(publishTopic, Encoding.UTF8.GetBytes("ld|VirtualRoboArm"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
        client.Publish(publishTopic, Encoding.UTF8.GetBytes($"mt4|{motor4Angle}"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
    }
